...
module.exports = class Parser {
          ...
          if (!schema.hasOwnProperty(key)) continue;
            ...
            if (typeof val === 'string') {
              ...
              if (!reader.validate(value)) {
                ...
                parsed[key.toLowerCase()] = reader.parse(value);
              }
            } else {
              ...
              if (!reader.validate(value)) {
                parsed[key.toLowerCase()] = getOption(val, 'default', null);
              } else {
  ...
  populateToEnv() {
    ...
    for (const [key, value] of Object.entries(parsed)) {
      if (!process.env.hasOwnProperty(key)) process.env[key.toUpperCase()] = value;
    }
  }
};
